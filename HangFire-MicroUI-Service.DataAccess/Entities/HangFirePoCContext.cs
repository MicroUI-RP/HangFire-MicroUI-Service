...
{
    public partial class HangFirePoCContext : DbContext
    {
        public HangFirePoCContext()
        {
        }

        public HangFirePoCContext(DbContextOptions<HangFirePoCContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=LAPTOP-BAV0JEMM\\SQLEXPRESS;Database=HangFire-PoC;Trusted_Connection=True;");
            }
        }
